...
CSP_SCRIPT_SRC = ["'self'", 'https://www.google-analytics.com', "https://stackpath.bootstrapcdn.com", "'unsafe-inline'"]
CSP_CONNECT_SRC = ["'self'", 'https://www.google-analytics.com']
CSP_IMG_SRC = ["'self'", 'https://www.google-analytics.com', 'https://*.googleusercontent.com']
CSP_FONT_SRC = ["'self'", 'https://fonts.gstatic.com', "https://stackpath.bootstrapcdn.com",]
CSP_STYLE_SRC = ["'self'", 'https://fonts.googleapis.com', "https://stackpath.bootstrapcdn.com", "'unsafe-inline'"]
